...
local date = wibox.widget.textclock(markup(white, " %A %d %B "))
...
theme.volume = lain.widget.pulse({
    settings = function()
        vlevel = "󰕾  " .. volume_now.right .. "% | " .. volume_now.device
        if volume_now.muted == "yes" then
            vlevel = vlevel .. " M"
        end
        widget:set_markup(markup.font(theme.font_11, vlevel))
    end
})
